...
class Helpers:
    ...
    def fetch_otp_from_microsoft(self, timeout=120):
        ...
        otp_email = self.fetch_dotenv("MICROSOFT_OTP_EMAIL") or os.getenv("MICROSOFT_OTP_EMAIL")
        ...
        if not otp_email: raise ValueError("MICROSOFT_OTP_EMAIL is not configured in .env")
