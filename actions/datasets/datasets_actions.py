...
class DatasetsActions:
    ...
    def click_datasets_menu(self):
        ...
        self.ui_utils.element_wait_for(self.page_factory.datasets_page.create_dataset_button, state="attached", timeout=10000)
    ...
    def create_dataset(self, dataset_name, dataset_type_name, description = None):
        ...
        self.ui_utils.element_wait_for(self.page_factory.datasets_page.dataset_cell, state="attached", timeout=10000)
